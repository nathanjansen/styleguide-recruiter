module.exports = ({ theme }) => ({
  DEFAULT: {
    css: {
      ...
      '--tw-prose-links': theme('colors.coral.500'),
      '--tw-prose-links-hover': theme('colors.coral.600'),
      '--tw-prose-links-underline': theme('colors.coral.500 / 0.3'),
      ...
      '--tw-prose-invert-links': theme('colors.coral.400'),
      '--tw-prose-invert-links-hover': theme('colors.coral.500'),
      '--tw-prose-invert-links-underline': theme('colors.coral.500 / 0.3'),
